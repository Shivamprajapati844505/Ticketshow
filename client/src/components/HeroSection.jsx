...
import bg_image from "../assets/backgroundImage.png";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 text-gray-300">
        ...
        <div className="flex items-center gap-1">
          <ClockIcon className="w-4.5 h-4.5" /> 2h 24m
        </div>
      </div>
      ...
      <button onClick={()=> navigate('/movies')} className="flex items-center gap-1 px-6 py-3 text-sm sm:px-4 sm:py-2.5 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer">
        Explore Movies
